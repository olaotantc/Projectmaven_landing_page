...
export default function HeroLeft() {
  return (
    <div className="flex items-center justify-center flex-col md:items-start"> {/* Centering content on mobile and displaying as block on desktop */}
      {/* Heading Section */}
      <TextHeading
        text={"Accelerate Your Product Development."} // Main heading text
        accentText={"Build Faster."} // Accent text for emphasis
        addStyles={"text-[42px] md:text-[35px] lg:text-[48px] font-extrabold text-center md:text-left "} // Custom styles for font size, weight, and alignment
      />
      <br />
      ...
      <p className="text-content-secondary md:text-base lg:text-lg">
        ...
        <TextAccent> Powered by AI</TextAccent> {/* Accent text for highlighting AI */}
      </p>
      <br />
      {/* Subscription Input */}
      <Input
