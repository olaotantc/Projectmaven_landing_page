...
export default function Footer() {
  return (
    <div className="bg-footer h-full mt-8"> {/* Footer container with background and margin */}
      <div className="container mx-auto py-24 md:py-auto md:p-24 text-center grid place-items-center"> {/* Centering content with responsive padding */}
        ...
        <Input
          ...
          subText={ // Additional text displayed below the input field
            <span className="mt-3">
        ...
        <div className="flex items-center justify-center gap-3 mt-5">
          {socialMedias.map((item) => { // Mapping through social media data to create links with icons
            return (
              <Link key={item.id} href={item.url}> {/* Each social media link */}
        ...
        <p className="mt-12">
          ...
          <TextAccent>Pricemaven</TextAccent> {/* TextAccent component used for styling the brand name */}
        </p>
      </div>
    </div>
  );
